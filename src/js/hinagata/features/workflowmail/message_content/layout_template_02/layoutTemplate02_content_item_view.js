...
module.exports = (function () {
	var LayoutTemplate02ContentItemView = Backbone.Marionette.ItemView.extend({
		template: require('./layoutTemplate02_content_item_template.html'),
		templateHelpers: {
	...
	return LayoutTemplate02ContentItemView;
