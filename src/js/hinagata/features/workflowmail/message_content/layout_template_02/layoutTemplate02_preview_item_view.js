...
module.exports = (function () {
	var LayoutTemplate02PreviewItemView = Backbone.Marionette.ItemView.extend({
		template: require('./layoutTemplate02_preview_item_template.html'),
		templateHelpers: {
	...
	return LayoutTemplate02PreviewItemView;
