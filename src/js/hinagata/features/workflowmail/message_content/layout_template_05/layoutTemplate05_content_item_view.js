...
module.exports = (function () {
	var LayoutTemplate05ContentItemView = Backbone.Marionette.ItemView.extend({
		template: require('./layoutTemplate05_content_item_template.html'),
		templateHelpers: {
	...
	return LayoutTemplate05ContentItemView;
