...
module.exports = (function () {
	var LayoutTemplate04ContentItemView = Backbone.Marionette.ItemView.extend({
		template: require('./layoutTemplate04_content_item_template.html'),
		templateHelpers: {
	...
	return LayoutTemplate04ContentItemView;
