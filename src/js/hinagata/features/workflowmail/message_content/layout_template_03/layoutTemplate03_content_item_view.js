...
module.exports = (function () {
	var LayoutTemplate03ContentItemView = Backbone.Marionette.ItemView.extend({
		template: require('./layoutTemplate03_content_item_template.html'),
		templateHelpers: {
	...
	return LayoutTemplate03ContentItemView;
