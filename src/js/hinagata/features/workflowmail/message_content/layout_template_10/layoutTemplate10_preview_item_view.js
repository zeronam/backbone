...
module.exports = (function () {
    var LayoutTemplate05PreviewItemView = Backbone.Marionette.ItemView.extend({
        template: require('./layoutTemplate10_preview_item_template.html'),
        templateHelpers: {
    ...
    return LayoutTemplate05PreviewItemView;
