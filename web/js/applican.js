...
// Version 1.12.3.1
//
// Copyright (c) 2013-2016 Newphoria Corporation. All rights reserved.
////////////////////////////////////////////////////////////////////////
var applican = null;
...
var LivepassError = function() {};
LivepassError.BUSY_ERROR = 'BUSY_ERROR';
LivepassError.REGISTER_ERROR = 'REGISTER_ERROR';
LivepassError.INVALID_ARGUMENT = 'INVALID_ARGUMENT';
LivepassError.UNKNOWN_ERROR = 'UNKNOWN_ERROR';
LivepassError.SETTINGS_ERROR = 'SETTINGS_ERROR';
LivepassError.LIVEPASS_DISABLED = 'LIVEPASS_DISABLED';
...
var _Livepass = function (config, queue) {
	...
	this.start = function (apiKey, apiSecret, successCallback, errorCallback, senderId) {
		if(this.isExecute){
			var error = {code:LivepassError.BUSY_ERROR, message:""};
			errorCallback(error);
			return;
		}
		...
		if(applican.config.debug){
			this.isExecute = false;
			successCallback({registrationId:"registrationId_xxxxxxxx"});
		}else{
	...
	this.getSettings = function (successCallback, errorCallback) {
		...
		if(applican.config.debug){
			this.isExecute = false;
			successCallback({notificationEnabled:true, locationEnabled:true, alias:"alias", tags:["tag1", "tag2"]});
		}else{
